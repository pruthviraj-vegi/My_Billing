...
def logins_overview(request):
    ...
    return render(request, "user/logins/main.html")
...
def fetch_logins_events(request):
    ...
    return render_paginated_response(request, events, "user/logins/fetch.html", 25)
...
def unauthorized_overview(request):
    ...
    return render(request, "user/unauthorised/main.html")
...
def fetch_unauthorised_events(request):
    ...
    return render_paginated_response(
        request, events, "user/unauthorised/fetch.html", 25
    )
