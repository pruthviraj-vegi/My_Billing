...
class AuditTableCreateView(RequiredPermissionMixin, CreateView):
...
class AuditTableDeleteView(RequiredPermissionMixin, DeleteView):
...
class InvoiceManager(RequiredPermissionMixin, View):
